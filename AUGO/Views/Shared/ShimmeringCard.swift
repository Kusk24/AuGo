...
struct HolographicCaptureCard: View {
    ...
    var body: some View {
        ...
        .shadow(color: rarityBadgeColor.opacity(0.26), radius: 14, y: 7)
        .shadow(color: rarityBadgeColor.opacity(0.14), radius: 10, y: 4)
    ...
    private var rarityGradientColors: [Color] {
        ARRarityPalette.gradientColors(for: normalizedRarity)
    }

    private var rarityBadgeColor: Color {
        ARRarityPalette.accentColor(for: normalizedRarity)
    }
